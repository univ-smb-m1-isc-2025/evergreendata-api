...
public class AdminCriteriaController {
    ...
    @PostMapping("/create")
    public ResponseEntity<CriteriaDTO> create(@RequestBody @Valid NewCriteriaBody newCriteriaBody) {
        return new ResponseEntity<>(new CriteriaDTO(criteriaService.create(newCriteriaBody.getName())), HttpStatus.CREATED);
    }
}
